...
savez_compressed('5-celebrity-faces-dataset-new.npz', trainX, trainy, testX, testy)
...
savez_compressed('5-celebrity-faces-embeddings-new.npz', newTrainX, trainy, newTestX, testy)

#load dataset
#data = load('5-celebrity-faces-embeddings.npz')
ata = load('5-celebrity-faces-embeddings-new.npz')
trainX, trainy, testX, testy = data['arr_0'], data['arr_1'], data['arr_2'], data['arr_3']
...
#load faces
data = load('5-celebrity-faces-dataset-new.npz')
testX_faces = data['arr_2']
# load face embeddings
data = load('5-celebrity-faces-embeddings-new.npz')
trainX, trainy, testX, testy = data['arr_0'], data['arr_1'], data['arr_2'], data['arr_3']
# normalize input vectors
in_encoder = Normalizer(norm='l2')
trainX = in_encoder.transform(trainX)
