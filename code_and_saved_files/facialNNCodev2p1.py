...
#load train dataset
trainX, trainy = load_dataset('kp-employees-dataset/train/')
print(trainX.shape, trainy.shape)
#load test dataset
testX, testy = load_dataset('kp-employees-dataset/val/')
print(testX.shape, testy.shape)
#save arrays to one file in compressed format
savez_compressed('kp-employees-dataset.npz', trainX, trainy, testX, testy)
...
#save arrays to one file in compressed format
savez_compressed('kp-employees-embeddings.npz', newTrainX, trainy, newTestX, testy)
