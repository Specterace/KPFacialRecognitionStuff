...
#function to extract all faces from a given photograph
...
#take an image, extract all faces in it, get their embeddings
#Declare the image file name and the name/class of the image in the call
inputImg = sys.argv[1]
input_face_pixels_list = extract_faces(inputImg)
for faceArray in input_face_pixels_list:
  input_face_emb = get_embedding(faceModel, faceArray)
